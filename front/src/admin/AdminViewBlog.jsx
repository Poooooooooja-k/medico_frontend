...
const AdminViewBlog = () => {
  ...
  const handleDelete = async (postId) => {
    try {
      const response = await AxiosInstance.get(`adminn/deleteblog/${postId}/`);
  ...
  const handleRestore = async (postId) => {
    try {
      const response = await AxiosInstance.get(`adminn/restoreblog/${postId}/`);
      console.log(response.data);
  ...
  const handleEdit = (postId) => {
    AxiosInstance.get(`adminn/getblog/${postId}`)
      .then(response => {
  ...
  const handleSaveEdit = () => {
    AxiosInstance.patch(`adminn/editblog/${editData.id}/`, editData)
      .then(response => {
