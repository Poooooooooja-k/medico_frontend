        ...
        {login && (
          <div className="h-32 grid grid-cols-12">
            ...
            <div className="hidden items-center justify-around col-span-11 md:flex">
              <Link to="/patient/homepage" className="text-black">
                Home
              </Link>
              <Link to="/patient/about" className="text-black">
                About
              </Link>
              <Link to="/patient/doctorlist" className="text-black">
                Doctors
              </Link>
              <Link to="/patient/blog" className="text-black">
                Blog
              </Link>
              <Link to="/patient/booking" className="text-black">
                Booking
              </Link>
